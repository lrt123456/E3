...
<ol class="breadcrumb">
					...
					<li><a href="01_IDKP0.jsp">选择的具体数据：IDKP0_00</a></li>
					<li class="active">散点图+显示具体数据：IDKP0_00</li>
				</ol>
								...
								<div class="col-sm-6  image ">
									<div class="thumbnail">
										...
										<div class="caption">
											...
											<p>
												<a href="#" class="btn btn-primary" role="button">收起具体数据</a>
												<a href="01_IDKP0.jsp" class="btn btn-default" role="button">收起</a>
											</p>
										</div>
									</div>
								</div>
